...
from fire_transformer.complexity import parameter_bytes, transformer_macs
        ...
        rows.append(
            {
                "model": name,
                "parameters": params,
                "fp32_weight_kib": parameter_bytes(model, 4) / 1024,
                "theoretical_int8_weight_kib": parameter_bytes(model, 1) / 1024,
                "mac_per_inference": macs,
                "mmac_per_inference": macs / 1e6,
                "approx_mflop": 2 * macs / 1e6,
            }
        )
